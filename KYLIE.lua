...
{{text = '𝙐𝙥𝙙𝙖𝙩𝙚𝙨 𝙆𝙮𝙡𝙞𝙚', url="t.me/P222P"}},
}
...
if text == ("صيح للمالكين") or text == ("تاك للملوك") then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
...
-----------------------------------------------------
if text == 'مسح الحاتات' and Mod(msg) then
...
-----------------------------------------------------
if text == 'مسح الصاكين' and Mod(msg) then
...
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع صخوله من الكروب')
end
...
-----------------------------------------------------
if text == 'مسح الجلاب' and Mod(msg) then
database:del(bot_id..'Motte:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع جلاب الكروب')
end
...
-----------------------------------------------------
if text == 'مسح القروده' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع القروده بالكروب')
end
...
-----------------------------------------------------
if text == 'مسح الضلوع' and Mod(msg) then
database:del(bot_id..'Bro:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع الضلوع بالكروب')
end
...
-----------------------------------------------------
if text == 'مسح الضلعات' and Mod(msg) then
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع الضلعات بالكروب')
end
...
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع البقرات بالكروب')
end
...
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع طليان بالكروب')
end
...
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع زواحف')
end
...
send(msg.chat_id_, msg.id_, ' ꙳.︙تم مسح جميع الجريذين')
end
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'كايلي')
send(msg.chat_id_, msg.id_,'اسـمَيہ ['..Namebot..'] ')
end
